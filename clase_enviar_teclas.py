...
# señal (carácter) por el cable USB simulando un teclado virtual.
# Para su funcionamiento debe estar disponible /dev/hidg0 tras
...
class Enviar_teclas():
    ...
    # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    # Cambio de la posición del lcd a la posición equiv. en la tabla de conv.
    def get_posicion_tabla_conversion(self):
        pos_v = self.posicion
    ...
    # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    # Busca el key code de un caracter pasado buscándolo en una tabla conv.
    def obtener_key_code_caracter(self):
        ...
        if posicion_kc1 != -1:
            ...
            return CODIGO_KEY_CODE_COMANDOS2[posicion_kc2] # Teclas control
        else:
    ...
    # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    #   Gestion de operaciones a hacer para escribir una tecla en
    ...
    def suma_string_de_bytes(self, key_code_string1, key_code_string2):
        ...
        # un 'valor' byte algo mayor de \0x7f va a añadir
