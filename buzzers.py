...
#   Descripcion: Varias funciones que hace sonar los
# buzzers con sonidos distintos.
...
#   NOTA: Se podria hacer con uno o dos shell scripts o con Adafruit GPIO.
#
...
#   NOTA2: El buzzer esta conectado al pin 18 de P8, siendo GPIO_65. Para
